...
$cliente = pg_query("SELECT * FROM usuarios_cliente WHERE cliente = '$usuario' AND password = '$clave'");
$vendedor = pg_query("SELECT * FROM usuarios_vendedor WHERE vendedor = '$usuario' AND password = '$clave'");
$gerente = pg_query("SELECT * FROM usuarios_gerente WHERE gerente = '$usuario' AND password = '$clave'");
